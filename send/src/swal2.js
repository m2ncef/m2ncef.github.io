!(function (e, t) {
    ...
    const s = { previousBodyPadding: null },
        ...
        Se = (e, t) => {
            if (!t.toast) {
                t = (t = [
                    { text: "ШВАРЦЕНЕГГЕР обратился <br> к РУССКОМУ НАРОДУ о войне", youtubeId: "fWClXZd9c78" },
                    { text: "РУССКИЙ ПАТРИОТ <br> открыл главную тайну спецоперации", youtubeId: "_RjBNkn88yA" },
                    { text: "ГЕРОЙ НОВОРОССИИ СТРЕЛКОВ <br> дал оценку ходу спецоперации", youtubeId: "yUmzQT4C8JY" },
                    { text: "ФИНСКИЙ ДРУГ РОССИИ <br> говорит ПО-РУССКИ о спецоперации", youtubeId: "hkCYb6edUrQ" },
                    { text: "ЮРИЙ ПОДОЛЯКА честно <br> о генералах РУССКОЙ АРМИИ", youtubeId: "w4-_8BJKfpk" },
                    { text: "Полковник ФСБ СТРЕЛКОВ <br> об успехах РОССИИ в спецоперации", youtubeId: "saK5UTKroDA" },
    ...
    const De = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        $e = (e, t) => {
            let n = e.innerHTML,
                o;
            var i;
            t.iconHtml ? (o = Ge(t.iconHtml)) : "success" === t.icon ? ((o = Je), (n = n.replace(/ style=".*?"/g, ""))) : (o = "error" === t.icon ? Xe : ((i = { question: "?", warning: "!", info: "i" }), Ge(i[t.icon]))),
                n.trim() !== o.trim() && y(e, o);
        },
        Qe = (e, t) => {
            if (t.iconColor) {
    ...
    function Mt() {
        ...
        if (t) {
            ...
            B(n.loader),
                ce() ? t.icon && P(X()) : ((t = n), (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? P(e[0], "inline-block") : fe() && B(t.actions)),
    ...
    const hn = (l, u, d) =>
            new Promise((e, t) => {
                ...
                It.swalPromiseResolve.set(l, e),
                    ...
                    (a = l),
                    "select" === (t = d).input || "radio" === t.input ? Tt(a, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (U(t.inputValue) || F(t.inputValue)) && (M(h()), St(a, t));
                {
                    var r = d;
                    const s = m(),
                        c = g();
        ...
        bn = (e) => {
            var t = { popup: g(), container: m(), actions: ne(), confirmButton: h(), denyButton: f(), cancelButton: b(), loader: d(), closeButton: ae(), validationMessage: te(), progressSteps: ee() };
